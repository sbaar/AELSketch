...
public class ArrangeMolecule
{
	...
	private boolean boxOverlaps(float x,float y,float w,float h,boolean[] pointmask,boolean[] linemask)
	{
		...
		for (int n=0;n<numLines();n++)
		{
			...
			if (linesIntersect(wx1,wy1,wx2,wy2, vx1,vy1,vx2,vy1)) return true;
			if (linesIntersect(wx1,wy1,wx2,wy2, vx1,vy2,vx2,vy2)) return true;
			if (linesIntersect(wx1,wy1,wx2,wy2, vx1,vy1,vx1,vy2)) return true;
			if (linesIntersect(wx1,wy1,wx2,wy2, vx2,vy1,vx2,vy2)) return true;
		}
